...
$(this).attr('maxlength','12')})}else if(params.format==='(xxx) xxx-xxxx'){$(this).on('keydown',function(e){if(e.which!=8&&e.which!=0&&(e.which<48||e.which>57)){return!1}
